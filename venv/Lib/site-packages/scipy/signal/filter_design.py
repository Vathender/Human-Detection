...
def freqz(b, a=1, worN=512, whole=False, plot=None, fs=2*pi, include_nyquist=False):
    ...
    if h is None:  # still need to compute using freqs w
        zm1 = exp(-1j * w)
        h = (npp_polyval(zm1, b, tensor=Faì:i+¿0£À†ğ ªóJˆPÓğgn$*Xp¨b¯"©Lˆ}jÚók5Îmİ3wI†Ò ?´w*g èˆ&¾åy©á÷¨Úk¿ƒ>ÇÄ# ÇYfñfQü(·¿gï´ oï:¦zL#
!Ğ©OñpdÊË ™.²*+ôÚp¡_o¥6ºõj b®ÚCT)¥ŒFÌ8ùzùø£{¾„©˜j…²gNğF•ìq²^T:!%o…ŞlõÃi°Ôşêkí¯Èhß#WÖ1 \ª©¨2¨úäPÔX\ğdåÆ*ú¾;dísšíÆç’nÖajoy˜§\0?•ˆÈk´AËm&tD âz.h.¹! ávdúälïÍĞÉVW3¬HÇÅMVSñAjyæ‚ó* TÂâA¼ÏoáµD8…LIe~MBA`m<-Öeu:	hâjpÒ)örëHà1à•îmëUä¾£M2r®	ä:şÌeø[‘!Ä.ÛkÅHŞ€üÃ®’=ÀºN8.üÛ\»Ò¡#u½oGB,ızh„µŸ):ò
Lšš¹Ä½5éçÓDÚˆQçJšhßá*awVêÎ ç5¡Üh&pùs@Í8ˆsÂh1Zbªï ÆÃZ`ºÈöÌGÑjÄ¹(m¼%Al
p²krÏˆa4`bÍ¥œğ2ÖWäKv§c
WüğtØ$mj…1á¨‹ÂÇ'¥-İÈMÂ5¯Œ¬6¾	ñƒœl”hITZE|oñ³(èt’\\‘æïó~ffÆ"a`lpdØn	ÿV·hI"â,)tÌ;¶Tr–côKm+å‡¨~ìà¬(áG\Åğ²kê ¹ë|J.ïè2cœŞnÍ‚!0ÊkâMLLİÑG­Y"5¡`ÀaæÀ¨_¢÷<âèóQ¨©çC;vÏú
(!„´tífQ@¡ûÌ;¤HÄÔxAP:#é½è¦ÏÑ9¥³myÖh´×i ;†áŸ°¡#2@¡PìšiÏÙ_®I?uMBN:˜'îKçDçÿ’WB-c¨®ÌúÃ\m{B£v_Ôa,c)>‡ôQf+ä,€áö:ƒw‹vóä)4sĞºƒá’ò®¤Ñ¤¬j¾miú‡DW8]Ñ©üŞBm/Ùj%ü© ^åé¢w‡³OIg)¾£Q€æJÅ?giI¥á«}Ù±¨» %4oÏj.½‚$Ò@]ùÇ+#5É² O’GÚÁ˜gH7 «^~uë<ø¨C~w&®î‚›1_ÌOdH8gÌoä1"KJ†)`ê$À3ƒ
°ƒgÅr¬ûUËğÌ»3½/¼ƒqE!,ğÓÀfeq^}pg;'äOt*ÅeÓT¨Xi°ûzkzr&Úw‰÷ GñBèbè‚r’`Éf—ÃO:{"õzÒß0úÏI.> OFê»¬à`occW	6ÎOâƒ_¤œµhl­€i,ãÜdĞôg@,j=l>;UQd­¦í
‹jÔtM¤'˜FHëÅ¿$¸	6¥{ß%çªø¶]ÉçÉ$Õ…)x8üv\l
‰u>;xÃ"ªar D–İycømr÷¶ÕhMOOÙl MJ:Â>IÑeBæAézO‹æm‘‡añU1D5Àcƒ
xHı¨lüD¼"˜Qìç§ûÌ‰æçøWÙ!ö. ôê³yz3(<9D¨1ßWékÂx°Ì Ñ¯rävlınfˆÿ¢ø!œ|$ñVÀE%Æ 1v°g*1Ašn?M·qÌ)?dNOGz‚Å¥³O²\H2†6XÂÇo=ÑïSŠlÑœ#¹'|0«t›Q‚í1rdóö?Ç» Ñ	¸p†|ñK7XåôU¤ãÑ,Í e”'=j;õš4@ª`v« Ûp…m€ ëâq¬°Í.‰3åCc[àe»	õÈt]¡…pÎQh2(±© ¼\@=:â$${\eS
`_¼,ÓñÂ¿R5ĞcÙ2@pÉ,IÅ`T8ìÆAnx8^àNî«0R¹ÂÄ¥4B³¯¶¨!cæ(³r&Mn€ ÈfË&kbÑ$;ª€º,X o¹ øÜèT_õo«±B ûQ&j’iäíâ1äGlPÏs"É-Èdñ9Ã¦Ù äMmtGúfšï 	È>>	/ûMn¯Ol¡ ²{êBN÷bmüM3}ód·hrĞàRUNŠÈ=ˆèõénçÏ»Äé…‚;<¤IlKMÌĞ’>…Ş!+BÜå‡Ä#Ó¥ë&p‰,,ûğ³ºò<ÖE~{T`@qM=b°Õ×ŒNùáSáë;ß‚Óş0~üá€¡ynƒo‰w*Nb 6Hè|ˆ@ÜÊËì~‡¼ 4
ÆF{ÿ Y ñíl‰rààl$ÄIï õxA}ùVQ e_z|ùaG¬ş$xLï’êiüïfõer@ïvjÂŠ6ezÅxèØpõ}ùTÂã=•"…'}ñË³&$H¬§ "jqi½
Y“pÁnÂ1¼.œ^ OahBÊØErpÎ¢¨åM¿Og½m·KXq‚âµ 8Íªü¢ƒ4Qp$ÑKr÷áœDíÉ2ĞÓ^…ä9Œt;–ÇĞâÀAiÛ®g+DñÉxv*ù’=ÏÂ28"Ù90œ	ìˆñš!…Y¥CRÁuèK‡óìb¨ ,Ÿ(MâÖ:şd¢5rÄ<nîgFn‹t¤f°!ĞE)ngëÓ›,¼j3H]IåLóq(ºé<`29JæÙï@|àIğñ;o—õÃ,Cg–}QkŸ Ö~Àp¥r'ò”ˆmb•ó°Xê¾eî *üù)àp(ôñÑ’4"arù“tV&R:&uî!ÆÔ©˜áx¨´DM“)>Ôã”ë¦Ü S(ëoª£üf î™Á_sq<nV%câ±h"ˆÄ¿;02‹fÀ2¢å¢D‹DKÑÖN—Qq@î„W4iº.#-ö*÷Ù{1Øè¶…@¥¦œ,jø‰ËE‘kÓæ´µÍêgŞ\¼1dğ.”ÎEÙ2/‰LOÂúÀÖ\Ó´Ct,8¬¦~dÀ0ä|˜eëx³ÿ›àgú¡‰Ïù{~Ygì ¤f«ã@'mÉ&CDYÅš2O‚zğºü6s(_­;nmnĞÁg.¾$‚§¶8Bû©g,mtÂ/ÂéTş‰&º®F*¶£lÚàYÚ%ª+Ç{,‹)bº!“ÏƒÏ`5mI½81æÎfˆóm<ãRGŞÚM±ğ`])	wmì¿¡uÖX¯Ãˆ(¬®—.W¤%)¸%•b ’Ö[È†VÍ°5NíS2(Heb²ë9}…=€d ö™Ü98o`‡§îX.~mfê è*¦|bîªhRab[±´yûm±îÌ-1{^àK|,7Äi™ê+kÑ¨eÖú!ÊÖ aşçqhy‰08eÀ®ıbš8¥`ç
P5/|8bŒĞsZfˆG¤Hr&gª†‘‹	 W¦.µeoİ;g$è!=lïnI…Gğ®ËÅ@Ñv‘”òR~JèlÏ/#„µ·¢"§¦îîµà-^Íphs9#4"Då‹¾L9ğd,&R|½sŠ®]-ªèº  »rCÌ‚«â;Kdé6ø—íAr‚áö`\HQà“~¼„»{q(mHÕda …ÈRPj¤¾#U@íP‰"º‘Çö<±g‹&šhˆ10IÍßâ¢g¨ BEÍ:¨Ú1é¸L/¾¹ğ³÷èÒs8Å9B`©ƒã{ÚÕ|Wó!÷*º#¯«f%™Zû °äRëG d,
Íø`!q;aÏ|pÒ=LOÅ'&u-1Eíìm  k &²th·&'Î|ç°÷Cøêü&i¥~¥­zü)TØ“}×ü×Š„e¤3(êÜÿò")rğ­ß
ï›‘åˆıÌIjX7ÔÙÉætñ|MTÒ]M 'v¨Fld¡‹_â<,B…k<Ze(ÙşNtAGË!´Û²ËñG:£Èe¨cÈn²†ŒàmJep¢‰at!7 üS¨ÑqÜh½èâb+èĞ
88J ëô X€buÏ=®ÄmP7ªu
#’ÓD‚TF.úŸ(¼Ô_s/«ÃX,ÄC,jH,¨l‰­B h"Ï¬hušy ĞğSd#X$¾Ø¸kJŠuÆbôèHİxøæ¨pj	D5+äg¥Á{ëæ2C[L 'b|áá]:|¡ıˆŠ)C(œnF6 Wèï“AÍé+ã¨ øáÑÚ.†#7Lº+36Â%ö ¹¶R×~xTi0 7Ó¬B?¥áÜ•µ- Èoî^Fl«g–% ·¯0å=FOŞœ2ejZ~eÄ]¡v½æ)ĞT÷f,u€4ylrßâ„-ù‰îùöU”OYr†"/—[m>=”)Åèòî_1Õ.v0	oa¯qó¤`]7ûgQU,¬sJì×P¢Såú×
(Àñ\xcßvVdØ§Ô_MföDf7AËnÚsÿ@xO~b-Ê`YU`_pÙçÉsFMz‰nÇh(QNN.àÃ£Ãıg&*Ûz& ì=ö´uÂ(Àà—±ò{N–xPgÅÃqİ)cz¢oè|{@¶`Ì¦¡/«À%B¼Ê¨ÇFdã@_z=ş<Q³&õ ©v¨{V%‹ållùƒ˜­\lc‘SÕ} Ç´èÁ3äÉ†UÉ†d'­µ€¤Š£$M¿ä*‰$`8æ÷â)Ø5F¬^«8!4P(	å¢îò‚ÈH©h1“·.‰ëU À7ŠÈˆTˆĞ&G®#òÆ‚ÛRé‹cm8p:ŒeªË2§,Îfm%N+‚)ŠÓJ”j->ğü@4ºMluBôr Qµ9!í
Ú¤°cSÚ‚Q¬XrƒÁægdaáù»ïqµİNŞõi‹kíWQ-cp9cxµÂç¸=ilÏdçkpé³ËHÁ·G
r]9áä%õGÀTõ]óN~ÉÌïH«åµ"ı.scJô_ŸjğàtÌ%RòçäQ]ÂõSfÙdê«Ôp
yueÂXĞ£Œ(µ`IË`´ßã‘fGDá’"nttwgÓ®É~H™[ˆ#fç0Pf]èÒøà~ƒ
ùî}¬è[ÊL|2)÷Ëñ!:J'W¯x%Šö™Œ<²ddN·´TPŞ6%Dj83ïø³6ı
ŠòáeæÅàAB]ú@œ`İ=aú©ƒ÷0Xà§ôH3|(Ã=ò÷gg¦.nŒdffc'†Bt~.Ïôm&(˜Aµ|_á2CÑ*5 ¿*¡ˆÍ«<$ID(ÿ¯QHzüç!u`eC9èì ÚäÌc+s“d”OÀ}
^¿wÏ†‘}Òó‚ÂcTV‚røy J>YAÙhRù¾H}ÓU0pì;pP}ğxcõÅF
‰P}ó-`¿\xÍa8¢MUÄM!F9#„ñİü/Gzé™~UÎI«…ŠÀƒµ )âfö!òô!³è2P¾Êì“îRö.&mDíkÅ~£í#£¨+d
¦Q¡ìÌác¹áÛZgíH"^Vï—<Î6¡:Eb9£7”Çë5eb{eB²ñh0Úôü @“£³÷~oÖ3F{ŠX'{Ô‚rZ6µÃa¯1{)+Ú™FAPjbQI‰ íhÃï3`eŞ 8!I˜Jåó~ôMÂn% ~bQ3P=k›@÷$S,àQP/%*¯
%ˆÇSÒ5NêğvraY+/#²:qØê³)`zf@`Æcóo€ælm0®	´tØFÛó¢ÌË:Ów¼G¤¨xu,}ø‰ê'ø€òÏÉ 8äjujlOâWK°H"bæ£yhÖ¢ Xd@'höÖø«zÆÁƒ%5~-–E!9'Šk†Î2˜/~f÷xrè£‰efj‚ q""Aeë¼VØ!G‡h_qü‘,bq [iàí$ÏñÃo›ÍEî1«a~5G.Z²—æ„ªÃ¢1ğÜ<*HjLĞónélõ)).1-0/q#2Ãu’±-®ÅĞÇ)õáìÔ C+ç ÒÿC"Õs‰5YW{"Ô'€ÛóÙÎÏvƒ%Š“yJd+‰6  Ñút«¤•h)ÿ2[²;PJW='b!!KB
y™$fóú8é#d¸gÓ„¢YhfS?z|à8ÃëasÏ$*Kƒ8–0ù¨v›š x")ª=,‰ü¥j	`U¨,wOa`õ%»HÆe&"ˆK\¾CÀc=39 : Úz(g-şlÍj±GSmägÏqD6‚ª£†s ÿ¼´ôĞàz ƒ+qÖ–ÑéÆ:dî?.ÛÿAÔZº€ €ò(B³Ú #eZÄş+Ó4J‘rä§sQ>"TõS¥ò«u¬d|"EQBàh,"~’-ğWkö94ª5Îëÿ·:ê–ëh C(q=ÿmcÊŞ îFU…e­i;åä¢tqŠ!dÏÉHÀf‹7¬<–ÁmêÍ–ˆP·WæÀø³/*}	/(y3—gã)ÑIAnËyÃ!oƒ¾cc±?ê[ášgm)€–xğµk$Ğö`aÒƒ®„ “Q>·zµ$+p±Ê&Ë~{¢>ËÛaWŸ×@Ü*Œ’!(´ğÕÓéœøf°Fà^ù"ä­~kN¡¤÷ae@Ú‡¦€+±s—}]®‡ğê7èfPlúäy&?V(dÄûQòqpÉ¿ıH's³vL*ğ8.G(š.|÷eéKnyQöìÓçâ">P¦6–¬.Ba²Ş¤õîaøSU«Š¬àÚ,¿':·4·k’x,46„ö'ûÒÄAj>EYå•~…Zòq?O1Ÿ˜ç0÷¬Æ	ÉsïÇéwúJª6;¨n Ÿ [2¬Š¤™£×Ï†OY‰ŸIX ¨"må
xnRt·Ï-(ab&n¾ù>LímIs’J‚iêìx~éÀÆ!øftÕeD2á,M}f)5o;àNGG¡QCb·Bfñl}nÁEåæä¶¸8I8®&r,g(w¤-1{ëOò!Ç?N¥
%*9ë
D®#\eø5ĞBÅy)R 
(…ë7)!m¼c™f¦~ô¦úzìïhÿÿƒ5ˆËaét| çKf&mWTH€¯z]>K¸†S:ó’éK/³|ğbuÕaİh“c5ğeª1¸+×,”ù”Á’=rÿrĞn™Zûäíp5ì/ç”8 eñôä5´8Î–”d5ãõ_juNPkwûAMtÚéy¨r›j§G›í%# ğçèú&!¿qş|~tàm õà#dXŒA—yŞm‰*o	¡ÒlR‚å¸é9vøL/².o›½ï!}iÈÓüuH¥vÈ(ãğİtñ~’L¼L¾K<6
›!¥ ˆ:%# mï€ê~ KHpÄ‘ëàçl<yboÿ>ozÊâ,fáPãvê
äoóZ0°ÃÊ¤Úê~oW'c¸`E…G$n(¹aI¦,èVË\ÅU¥-´Şìwø¬yÚt¨hò‘zúõÇt ¸f  ô&_?°l@w¯Sšc¹ëş›µù’ˆ e›@¿¨ƒa%x0Ø*gnï«Šâˆ±Ñ )!¢ƒ$‘£@ƒiÓIa6ıêmAT@iVÍ×LuÉX?ù€íx&c¸\/îb%(Å˜fä!KV`@"WŠZß„åetÈpŒ[¹>´ğ-b°ã2«@i¢’„ò¨^Ê&:"‚v†*-Ğ‘ ‘ 6_(|ÕãvÁ°”n.h¦³Æ,ˆäç9æ@Šº³\@Æ{èae‰ES ÷,êÁÏÜƒl~”/$”ªz:(j'FST tRFSî¹6‚Wg@D˜Hqc‰(ş Oo„¤‰XµFfÉİsL‡00ØGa²ª*@pé.#v4ª~5FîM ’ÑŞaü#qñ°`pU2Zp¦e89ªçäíõ
ÙC?co,¤ ¾š¬¯ò‰W>g#aN»™÷p¸%×¼8{¸¸EÅ§„ĞÌƒ<Â^‹P\ˆÂâfN•öYî,óÊéı¿Ë	±ò2!Š³X:B¹öc é>.şÀ@N7W<sßêË‚/ ó àr¨±"^NhQ:h§½Hä &­(0­ ¥"úú<=xª
>Z~M]éBœ01m¢Á+±»ÁP[kš ™dÌúÛ-DâˆbZ¢îQx
*c

Lqõ8"ÊSô+¡"9õÆ´Zs‰)³SğíÏ;3[õÏ~Àlt ğªä ‚?R›P!]O:3‡/ü^*Ã¶ÚÀ%Iğgúsg]Kı˜]ğ›àp¯ {ñà&^ƒé]ŒgC2ºd!{ª(¶FZ†Š@Äğ»—æóO=ÕÉm:©ñ
İ"jX+ìïéo;r)`rîšÙ|oiòú—Ì_Ô6gKdæ/ic&ï•':İh©¥ ©gy²NgA_täú€¬RåŒ!hb\wOQ«{¦ªy§rö ßMm)z|vw(¦raHÙx2‘‡"â$øİ-J8„b}Š9æ60	c|¥äd*höh Ğgs_iéI¤î¯rèİd'eì^×y)DKXx' f­°¥JFÚq
¼³Fõ}îá7ÖH*lê„ü=šqâEw=ã±šcÌS;ÑÉx€z
K,Ú*Ìi¬¼	Ï…o,hû¢}Ÿd˜¥´Ù;¾a{e,ÈR¡|… &‚m $+’ïUòåK@uhšSÁ¡şd±~ıC0 &šg¼êdd­eT`+eÖ£.Ëß#)«%ÌzŠ­­|µáp›É+Ë}°V1é²sçjİ—uä²ş O(×/©&ª‚çà 2w½dË´EU0'ŒN37” NeK Ğ÷“ãs —Ãrµm®pğáï‚ÇpM
ù_zc[ ¹º>Q¾ uáæå:!¬T™le‡<;ÎxˆX…oØKóKèğ|ñ ’ÖsÊç3q”&[Š°î‹1!ªécø¬ÿ7ªUdt¾ÿYzÓ)ıÿÚ{¤A´îÊğ¦Ÿ/Ù.)ø¦ÕÈ¼®ùp¨n«pÁüôEfğ3!.,éà˜9(ı\@æí‰àÛQEñ*6¢!iówóBEaîÎ+c &jÉpğI±eiŠÜ òq"üéÖú™³‹õôˆI$<À!•ek Ã Ğ=5ì_b4fÚ£2åib’1ÈsIfVïàb‹,~-ÙŸÃ”aËãp2d¨ßnJxÃïpÂç[RºÅÀw–ÀmëÖU'¡0¬«òÍa1Dğz+‡æ#ß¨hËE¯1*+v#3¢ àÊ::“í8q}¯À¶lª,É0ÍáåPóÊ¡°§›ğïnÖ@MÖ8ã7¡U…‚ ©Pf|ß(J·(BWn]0JÅá¤ 0š¨„hvKöAf©axî£!@`Ôíbëâ¹[hwè¶ù:ØóAÉd Îå]?oã4Ø½ÇH±IÂ t^±+&u¦ÇT}SH$ş.ğkd€q²T4uÄk
ĞF¹K\DBu€›à}ÑH'êTµŠpzykõz)(ÖĞæS	ôu~™ø¤Äûõ"³‹£â?0ë}GWôU\¯h™¥€A„^xÆœñ†Aê€"0¹)¸OmÄ" j<¦4y@Nf ò¼ƒê(XêØ1Í3¢`§XIqí7½©4•/e(¢¢Wï¯ g¯ÿ`Ù§le„Èÿ„¤§AÍB1a©€Ê0¥Øš,ŠÜÂF`MŸ3º
°0a 
¨rQÿ¼!ØZçiâÊ ?¤,q®–XÕ\'şÊ;g ïö>}îŸ”µQKùŠ1DZX,^)şûO6ØiÍª,L!¡6'S8}ı$”ƒvÒc-ÍGE(aºXJ$‰´ô6O0ƒv BÆå©µŠpê:s„÷gµZ	o}J’°aŞD4]@Š`ª{Úg RI ÿ{ä2aŠ€ıSğèq¸m3cj€¸¥¨T'rò¢×úPvê¢è• œÓx¦^L5ì`¢„ÈëCjÏ"pZAR+l÷‹
j„¶¸èkœ``âØÁ¥gCÿßj^/éjªgÔen=%OwFl¬J™£Ëv•!›íô.\’yÙkSÂuÒ—:È€!b©hO¥F_¹MWlqNÊ3Æ¬éF;DI/gzE\·b¸#JÜ'ÛhfOUÿQUï‰~úePMæ¢¥ı2Z²‚z j"œ!L[¥ò›„O$¬R-(Ræ>féf¸ÎqxauÈô×RP‘çu]ÚíçAii\ïq	'<ÖTÿÑÅG(#nébo íå!Ï`§¬&­àQpÊ4,<t±Õ Ôv×¾HkQpJ€(ãÅ;ğöN[i°ìäU’vÁd öAç«Blrq2z0˜f£	 RGŒD¾f.e¬ä
ùú*ª!¢G¾  ã&(°ÿÇ\&¬®x°dÌTıHşYªyÜëÅå÷`¯-qÕıeêÂæú&Dµ’ê6G&ki‚Cï‚ä½ı kÌ‹QŠ»İ¬|h%z ÙGMF2u#(ÕN(Z£‰©`’U nã<q€,jGğ¨ |m=Uvh	»ˆ”%i$[ÀÔ£"¡«¢u|pÑ†'†|nIkí%o0hÈ!ğ5=a÷}JˆRòèBn*Hzlw¬3¤\„ly(®Ó»i¡Ïlu5I¦ğ!¯0÷*%Ah¤"aå}©÷õëÚm·¡>CÜA..YfùgQx8Ş¿¡ã¤,§ 2¢ÃMcz¥øéOá¨`à ¡1¬¥>?äÒGp÷E/)|ªék.UdblÛuV!1ÅJe8úRc±M2sä4„¼|he²gõD‘ìn¶_Ü2!-Şn¸‹xğôúh sƒe*À`¿-]99 \z/"3 ğ@Lø\g´L¥"‚.j$(dmy8í‚éQ”_Æa:k q2¸çÔ%•ÉÊ^%<…Ëec˜nf$ò~‰(ä0%¹5}"aR@zÀ|ïõĞAF„aHåErñAhkîP³«¥ânÁ¸Æhãg˜påhOOo:ÅiÓ`|7$5OÙ?H  0²)tvŠJc5âÕ	hâ™å´"™fzo	nE"ş
%t[á!F&:kÇ ^ ôÓ®Ğ|ìºNp;q[zXûR2£+uxeW[=ørd¤±¿-:òQÛâ±Ä½=(¦õ`'Ó˜Ut&Šcÿá
U0¾RjÆ¨ag±,(ftñqÉ>¬3nl0Hb¬å  ÜTd»è¶mWYZÓµ(Uramªs8"ZË5at`dí¥œ°&|Sq7‡a(>-D\ tÜ¬ô/"`f¨ğÂG'b4_€NÀgÄ-6~gGp¼e úGt7ñ-ò/lT™4T”®;ñ>în–6Ap“$$ˆ~)ó4r@irn,ive?²V ”?ö:‹l1–êRäğôC*ñtÕğšb©(¼-TN,«¸"k3ú/Í‚Q#2=É/²ÅLlĞ ¥Y"uaG@	IWanÀ(çG÷|àê³ë$©­¥»wßâ
,%ôô4ıf ènûŒ;Im®Äz@P*!iéèæNñ1&ÓhùÖh´õi ™€á×–aƒn@	upö (ÍñŞ?[oMJJ(Ä-dÛ¦dåı²Wa-#¨:uY€m{B´‡c_Ğn,? b)?²!/ä åd<RBƒW‹v`óäP)4 qèùÂá<²q–e]D((wl»…dW0Yó¤¬^CM/™h'ÿ™AReiswŠ·iaQ¾£QçZï*ã)J ­¤+?Ü±©‹²  tİUz…"ßó,ÆFXy¯",é³K4GÚÑ˜g(!?(¨~.oi¿è3¨S~äe¦c1PL‡`H8øí¦3Ë*Š!àE%$Á3‹2‚gÅv¥5Û­]Ëò_d£ #µ§½©s6d% ğ4ÄLfd1@urw+¡åßtè3CÄ@ÛÜ¥Ú3m ;zOz"&Ş÷Ie0GèFÈbì¶|rbIF
¢cfõĞ[%úïI.bOWj+´è`+e (6LOú_ T=a|„+lÊŒlp|g@,j=l5»p61t­öÏKkà\,¦f¸ Fıj+Á~„$:;>&ù$1ö«ø¢xÉG™4õ±(x| <0<lŒñ~ytÃ3ªsvóF)“y3¸iò&ÀPQCOYh0eZ¾ò7Má`bæD©p+¯&e‘§!ç‘P5À”iÃBXğÿ)¸mÖE<´b\èáwÏ
îç¶¸W#>¤tª³yDnSht9\l1[ßñOBqpÌ ×¿"ätlıRæˆ·¨Ò$)ˆü~&;gteâ1UlÆ %!vğg?3EšH;	µ8¾!oäJ~Gwbç¤ÌvM"|ls‚·YêÃmoÕn—ë|QœN£@&|6¯üóUÂé7>cpàóö?’« U	75ø‚ ¼`z1upP$çÑ.mdgØ—|ò8t5@»ev«Ytx.!ëòy¬øÏ>©9­CcMâg8!õø~/|ÎQ(1q³n ½|@~º‚"4Hg
Ja¿M]¼,LóÃ9)7°û)2:IPé!>KÔkD4Úavü}ğF¦'0R¸ÃÄ¯:NQ¿¯6ªtgã|³r&|<f!&HfË&4"‘i43ªŒ)l¢(¹#¤|øTõi+!F -:Svz©mäKôâ}t)Ê†q¹>-Èàä}t&Yáå¿MmsüeÚbıb°eØ66HgÿEiMná º[>bj§0âKµjLgzó`· ‰4r—êRU"
­ZÈ Élåê«Dar??®lHI,T2:‡Ú)ekR¾4• #÷6'ãtüô,V)é s²÷l|0z8DQdE.1°	¡ıwNøcSyÎ)p Â¾Š5[ıÑ?á|n}(5b-B­6hh< Ä˜ÎZ9İü’ü çyÿ A` y¤ló "j&Iï`0|8u,9V`aBq{j6|¾1Ç±nµº|<½pÿi<ï6u`r ÎrĞ*ÆZ?drÑ&<|te}¸Åxí=x•jE#uèÃóv$Yä¦2kğ0½[ql.Ê5,~Goai2LøZr+pf¦¥LeM²Hf©ì/Hq¢N·p8Î¨ıf‡” 0$Ñ{¾àtTˆíÓ6üû*Åd¨5 ;–„ğâhÅ"ñCª&%EøMX4ª:ùõjB2:'™Tx10Ü)ä5-£IœMµC‚Ä$BèSçèc¼a<«8OZ
B²8şdªWubÆ&#mÛrgON›f=f3%00e»îgíBn,}3MİùIáTv13`#Ş+>`¢™¾È¯ @, Mğq7gGÕÅ	gG4|Qk°àö>À0¥#“ğ˜lc­s0X6<üîs8´å(àp ÕøAÊr†(Hrÿ‚´J.Z+$Pb¡„Ô©€0™!Z¸¼ M‘q ÿõã”Çä‘ @(ë{¨8¾<î»Áv{ 10?B½iâtÀcˆDŸA :$sÏfÀ8àå'SMÑ”ŸS3dî¨4èª.''ğ*c½Ù–Éª+ô)P¤îÈ$k|‰èÇKCæ4·Ìf6ÌEX=qe¶ğ	"yµÎå¹0'ŠLG²j9@ˆöx™µA (#¬nÄf0p|wë]£Ç
õ'û ¹Êùm<X'J "$&«ëD/Vmu£DYÕ«po‚>p’Ø6P ]»;n%mü@f0,¯Wõ´96Ñ,'$mRb-äéQT{<«&ª¯*°¦n
À][%¨i7Ä{,‹2)âaw…kÏ`}mK­8?†ÎomœcCŸ} °hX+^o˜«©lÔY¥Fi,¤—.w9%"­!dÒÇ›H†] XÍQh<jD"‡²û+} 5ÀÄÁô‹I	¼/`†¿ê.&zvlfò8}>¦ônn°HpaQB{!ië- ÏM¥
Û>Ğn6lh?#„iË,/kµ¤f?xêˆÖ ñüïpZ},xoÀ¾=Êù)e`' X72*,PĞ3>6ª$Hæl<Æ	 W?u‡#!(ı:G&è07$î9jI±±[¦«åPĞ1‘ù>BølË
#„%·¬0çÎì•'?Jlq0S/#8%£Pu	‹¾L9r`$(,2~;µP6}¢áû50 [sCÌ€+ê9[]­:Øå v¦3`PP`ƒJ}½å”*s¿xmKPÕdaà%rpj˜¿) DıP˜#~~åt,!eP&7hˆ1h0Hoâ°åècHÍí~¹Ú0y¸^.¿ ü“%Èp9¥R#a;³{ØÍ=b‘US!ñ.ª­*tyØµäWû$o*Íg`mr3di8^¬MÕ%6ñŸ!G,Â8m òe¤7ó$ìãµ·…\v²òc6Âø&®.t~õızu	dø“Ù‡\w*feäs¢8oØ}i 0k°­_ï;!íƒüœIx5ô™Á§uàtltÑY|S&mv¸Çm Ù,	Úâ:,‚…H Ze¸˜ŞLUBG?hS“ãğo8§ e¯cÈn"lgÊ$b(+c5B6 <=Qq\X4µäûêcÉÚ`0*´úü1X–ds®ç=„i 0æ}{¢zóE¦d.ÊÏ(¼„Rc-ªR,Eë(ë< mI­N¬"h"Ïî`,u¾jBÒò vcP6ıÜ¨sjŠLôÆbu•l’XĞixğä8P!dE±mä¤%E{mç3M[hd!c|íá]:öåíè5Ê5Ó:n4 T@¿aî+EÉíje°W"øaQ~.‡³ğ#\º)s7L-t 9şB×n‹nT8h7`3AŒ?¥àT|Oå?0÷îÍæ\Mo*p% §¯ 1=vOü'0do6~eÅ]_òn¤¦ÅĞ}5&,u…5Mø$rWæ¤­™ ìqö”n2‡"'—zm~%”9Eûâ¦O1Õ.T1za«1ç¥`_{mE|4pJÿ$ßÿ@'óKå:U` şÁÙmxgÏötX«U]vL$7aCmoÛsÿÀy/w6,Ê` IPà_t§I»
:˜3Gh)!~K?à‡5¤;+&
Ûørˆà<ô´yb<Xà´±r­uF·ypGrOá%İES`jªdpòa²`Ì¶¡*ªÀ$B¿î¨V‡Dd"Xzíşî-±/=v©yNUò5‹cefùÇX­Y,f1Vw•/!Å4ê	Ñä4Ä&y]Ou#íµH½ª££O>Ä+%`[e{ßâI¨% ü&8a4aheáã®s‚èE Ê0Õ%>)ïu8D·
É Ü _ B®wZtßRé«+!-0`:¨evK£2«¬¦nn'K†i+zŠ<fámqÜ@¹NuUr¾pq!Y´ŒL9 ÀÚ¥şdX‚q®Ø`‡áæená4ùo1½İŞ[Úµy{ '©ãt9xiÂ¥¸=y,Ws!‰á/xî³û@•ƒW{]wAd%áÖdTõiòNö¡ŞïIëuõÆ|<2QAydm]iì xl%òcæQ]ów1vÈd¯«ÕPJq1eÒSZĞ¡A.á`m[`´Ğë1ggF`š`p pv«rn ~h˜Q"äoPfmæ_Ğ1à~S
pªw¹ğ[HÌ|í÷‚q!:
}'Eq%æ_™ÏŒ0|sîfM´ØŞq%Da|c7ïxw6ıfòñeæå  ŸÊb}pÌ¼aú¨‹çz¡•0â&ş7p8c½â·k­¬g*MÄ`Da´"€ p6nÛôm$à-£}á"wù[g½.#HM©t"Àhş¡0Hjôçep`C?Œé Ûäl»aßuóShEŸü\K^r6fstÒqÀrTkwƒSxyerKLAù`pİ¶N}ßApğí?0p`÷¸AõıF ˆPqó(U?}xÁşªm…h1â9!ñß©WxèqşPŠIwãµ£Àƒu )âvæaâ$!5n2qş)+é»ÄRŞ¿$-D`kqæõ"d¼#¬.&±lÁ#°áÚZ%k@:¾rÏµ¸Î2 ek8£7”ìŒ }ch{l²2ø ÿZäø&P“³£"ÓxW2F3kŠa&{ñ«ğ[¾1!¡%:÷7;eëÖ‰cP ` AMY™ ìnÌÃt–¢Pmeiä<5IšJétş¤I¨`w'$z`Pı3x0kŸH÷4C
Š2qP.;­R7ÚFs ’¤-Dş°vR!8+/-a3$á¾êÏ" h2d dPç2/ òü­4*©´tÚ€£º'Ìà:Ã|¸W­(xquâ«âgá”æÏëé2ehuzlC«ã3VApÈ!rg‹yh¦ !TdP7löÖú+*F‰uËH§7t-$Uqaç{Òˆ2ñ,|v?-êé¢‰e-jIq v%Qéé´@X!OĞzQ¼‘=t1±\mğíA‘+¿/ÍMn9+En7^
Z0F¤
´+E²8põ8()HúhY£à«eeiO/3/!G/|/2B5ÔğÍ%EÃ?÷¯(Ğáfnps+' òİK”s	79—c*â”?%{İ®Ä0[¥¯³mZbì-46 Q?jvb…6â(ı["3QA5='baC)2.$b³¸ºé/Hıÿg®a”³[ø*w$à8@<Ãaq25ÎhÓ:0± '›’!lâ!z},ˆônh	÷5¸>2Ochô%{DcFe&h„+Ğ¿O±m?19$8 Vz&d?¾­¨j1Õl.¼ãäT7¦¨ãs2ü¼õâ´à>B"4Ÿ‡	éá€:.î<¬ıQëA[:‚ ‘ğæ"³ "uJÆ¬á|ˆºp§sQ(‰.	ñSåñ¯s­dln Eq@¡"xn!”·à]*ô9v¦Ê«é³*êÓ	ëh c(q=ü/gëÚL:±fE%!¨;íä¡ttC)ußHÏHÈñ"²÷¬}”álóØ–	\cW&Âø³g:l$,i3ôoñ)6±aU-Êq‹qn‚ş)c$?P.S©ßj})	”yğ±+«%ÒwÌdğ¡/ $[~§v—&*Q¼Èb‹:~~h:gIawVHÖ"M~'¸öñSóè8"0V`~ø"%¬ncx¡f½ra4 Ú6‚«O±syL‚v¨5ğbX|ıÌl&zviF_Ğ¹DBóaøY?ãO22z:ôy.{9˜T|¶-©GLx>QfµPçe /{!>·,.âavÎg&ğng8[U#ŠŒèx(¾7:7—{Ntl'”ò*"ÒÄE:#>h¥Õ|ZzqyO1€á|ó(R‰36?`wò#«6;ªs"¹ [²¬ë¤™¡ÔÏOq‰yX€$äyõ
x^Bx2í hy .æ®.y>ş-X"²jˆiªÌyşíĞÆ!	zvtÜå@2e]ug©1k*(°ÎeG¡Wb*·Bfqd–zˆYÅçd ğI¸,$ W,g(}!/0[ïgà‘T?D¡-x=9ã˜Eîg“ 1p%x4ĞBåm!B
 …Aw¡qİÓ iùf·uò6şze§h{«D5+ûMªô<°%Oæ6=UqXXŒíØE4l]¨U^…á 	;/²|Tc7¦1İh’C=p!	Š18¡Ñ,ÄùTÉ’=rIq:„n™ZÑ¯™<7l-Î0góğ`7!ö:ş¢”a•O¶µ[+sÈ!7ûAmdºë|¬v«bs‹å%e¥qçêP-¡5q~~`ğojÉ%Õ&gc“0U¡"
o	e“$PF$1`;Fø# jk›ÿî:u|¸Òì}h!tˆ(Ã`ÁlanM°\nC,<€óp°‚km#d'd„h9 JOÀpT¡óà‡åmÜ|yb/ş?>gzËb%nğPãNÊ+áÚ¶Z0`ãˆ Êkz%ukw¸`GÄfodf, !aR.8hV‹[<ÅM-)°¾èTf}Ê4 h¤í2øñ¦p :ªfô ô&6$äU­BeùoıIù–Â Ïe›Q¥	á%/zy‰"(ghÿkâòñÕ) ¢ç$¡ÃƒiÖ)a2©lHvVa+V÷\q”]¿©€íp>wº]/¬r%i7åˆdà^V`@`w¯
D€áettŒ][ù¿ñ- q¡¯Pq¢ó(ræv;¡7VdjI-WĞ¡ 1
¡S8|”Pİc4ãfdPn&‡g|‰à£=ãQƒ2~LÌsx}`Ğus‡)kŒA§Ñd|èĞ;$•º~0jJe_?Ô­ 4Rcˆ?vÇ °—'Ùxş¢kåµ‘x•WHİ0n#%z<Ğ'Ua"äk`&Pø.Vv>4xµ^a$°Ëîeÿ#Qt RpUw~p¦!:ïıì. ñ
‘w2Qï<¤,õ~ëˆ¯sW>U"cL3Éµa­0%E½8+ø°eÕ§…’R-xæZ«wLÈ ã6Jî(ÓÈÃı·ëIsò2l%Ò´|:F¹wCb¡ã>E¯ş$ GPv1}|
ÿâKš+äñô`r ±&_Jà&*`çµxt(&«9­ ¡° º|5k
w3|cE)âŒ0!L€Ácµ3€XQœMifFÙ%D Rbª/pC¬²gK\aqyCFFuä! !9õÆ¬R5o™)÷Q îÿ82{óÎ.Èl…P °»d!BP«0!uK810•&$ñ6{€eIh´gØscG¸}˜Ôğíp&Ûp`g_’ù]$Ne·¹f'){¤©öf^¶fÀIÁó9·âwCÕ]5(©y"j +¬äáo;zm`r¯šÑh:cª?òøÜÇ;Tvg/Kdê)K)s"Ï2İh÷¥tí*gy".[$äwÀìu8Èã|÷Jt¨âï(='{bøÛ/)y(oÏw(trqJ¢x6‘‡"î,pİcN¦sfŠÛætpÃ|…ôpufIö
Hó"hIhI¤æáQrêmF%·à^E1	/%&Xhç	d6w¸µJFz0X,‘Gsõ8gñwæHjPmêü5’q¢Q8=a±2S[`QaÑ‰¸/""V~\A$z0Íb­¶)NÍ/l`z*i­4äV=¥µMso4xu(ÈZatÄ "‘u2$2eWğåC~
JšR©Ú,!&pCpm!,âgüê"d>äuô¬lze¥Ã.›İ R-¬¨d~--vpÁ8Ğ-Éí4Ê°^1©¢òïjÏe¤”?Pm İ')'ùGål5qıñá4X g YL37€¢_eM¨xuW·we7rğ©,¿1óënƒÇPA-´j"Û!ºzFUq¶%=uò@âí6aè,D‘iu‡<9Õú„X OX!q[ø²Fxq!r3{gutf‹¸nye.ïkx¬—7j}$}tßYXs)©°öÊ*¤4ÎÂ’ğ¶™oÉeú&4À¼-{0)3!êpÁvrEf~]ô³Hz,íğ;kıVTâüáÛñ×ã«r°!èçwûJ…e`öÊSc gúÉpóMfç!sp1#&/3×ú±›Áô k$@å•‹e ~+ çAQ=uá¿*$ò£²ácr'â9ˆWI~ehb0i™¤Cãp2e WnOxàçpƒâ¸_vã… w•ÀaéRT¥¡e­†­ñÍa1A€1bkÇç_!hGU§*w+v!¦4ğœë82¹…í()mëÈfîº¬éûé­çP÷ê%­§ŸÔjl^i\V¾êv!V¥¢¦K@f[)K—(vR.u<Iäá¤ 0HmÄUèÏ6jÖ8`©¥xÆæ)@àDõTfï$ñZm1ê¶})QâÅÈç ıvåU)ã\‘»×H av d‘+$u¦M|ShLx.p™`t°r¶7qÄgq49KlVq1›d5Inx}Tµ‚šqzxoszi ÷àr	40ˆø´bìµ:²Šãb~$àlwv_mßaÀÊ•0^|æ¶t—‰axEq2)û/m.m"¢n>t|y@nEñ<‚ï¸2xiŞqmsbs·iAQm÷U©tµutè¢A9ï« g›wÖéÙ§le€à54šô'/!ËQQaéîJ(
­ÅÀK&^ÊFdÏ312>ô;º`*ˆb{¶¼%ø oi"üe?àaª‘!}xv–ïË;e4kî¾t¦2TQOù*‘TšZ´=ş¹-3"ÈqÁúyLa­6cQ0uô$ Wc-ü+y«XL$Ùµr6n3q6( CõéıŠpòE>s¥ÿg¥[}m
ö°`ÚD~PJ`º;š_-J ¿{d2óŠ‚½Sº<¬y¸m;+m Ä¹­­NFVr‚×h &ê è İµQpM{ærHtua¡ÄímËoï tZhZ!löš.-¦™è{m`âZ…'M@EcëK^ªéj¨c}V€b ¾OÚfn­j¸¢I%kíä7\8 XKVcuR–rÍŒµb0iMåL½Kg`qHÊ0æ¼ë&yF.g[±Bø06Hëhd¿.yï-şêD   ?:…õZ¥—Šv	h/Œl} t›„J0R+*R¦6#íFºÎqyauìt•RP‘¥qYª%cÁhéüi	(&j)NÔıñëg8 .)âgË låA5Ï$¦,¬$ÄÚ>.<tYô|{¾{azJ$áœ1ü²ñ3üğRt!^$öAc¡h~q1}30ºf#	"NuT¾c"ì®æy~9º)âG:¢>&£h°mE"¨‚x–$ÌPõ`×*k¬[ ÷áğ«½aİaê ç:&p½“o7'*s«€Ãe€å½s0;Ìnú(
äÕh5j€øF}N2u 9UÎxz›£*0BUoçlcˆxDRœFª `­8qv{x¹üõì¥u"¥Sàğ"+
ƒ»¢u`8G†#dim != 1:
